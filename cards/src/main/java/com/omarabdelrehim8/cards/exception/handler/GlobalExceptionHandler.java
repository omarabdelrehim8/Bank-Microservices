package com.omarabdelrehim8.cards.exception.handler;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(AccountNumberAndCustomerIdMismatchException.class)
    public ResponseEntity<ErrorResponseDto> handleAccountNumberAndCustomerIdMismatchException(Exception exception, HttpServletRequest request) {
